...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (role.position >= message.member.roles.highest.position && message.member.id !== message.guild.ownerId) return client.util.throwError(message, client.config.errors.hierarchy);
        ...
        if (!member.roles.cache.has(role.id)) return client.util.throwError(message, 'This member does not has this role!');
