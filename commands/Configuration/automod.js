...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        const automodList = new Discord.MessageEmbed()
            ...
            .addField('Fast', `Toggled: \`${fastTempMuteDuration ? fast + ' for ' + client.util.duration(fastTempMuteDuration) : fastTempBanDuration ? fast + ' for ' + client.util.duration(fastTempBanDuration) : fast}\``, true)
            ...
            case 'filter':
                switch (toggle) {
                    ...
                    case 'tempban':
                        ...
                        message.reply(`Members who send words on the \`Filtered List\` will get banned for \`${client.util.duration(duration)}\``)
                        break;
                    case 'tempmute':
                        updateFilter('tempmute', duration)
                        message.reply(`Members who send words on the \`Filtered List\` will get muted for  \`${client.util.duration(duration)}\``)
                        break;
                    case 'disable':
            ...
            case 'filterlist':
                ...
                switch (toggle) {
                    case 'add':
                        ...
                        if (wordAlreadyInFilter?.length !== 0) return message.reply('This word is already in the filter! Run `automod filter view` to view the current list of filtered words')
                        await automodSchema.updateOne({
                            guildID: message.guild.id
                        },
                            {
                    ...
                    case 'remove':
                        ...
                        if (!wordNotInFilter || !wordNotInFilter.length) return message.reply(`Could not find the word \`${word}\` on the filter. Run \`automod filterlist view\` to view the current list of filtered words`)
                        await automodSchema.updateOne({
                            guildID: message.guild.id
                        },
                            {
                ...
                switch (toggle) {
                    ...
                    case 'tempban':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                                .setColor(client.config.colors.main)
                                .setDescription(`${client.config.emotes.success} Members who send fast message spam will get banned for \`${client.util.duration(duration)}\``)
                                .setAuthor('Automod Update', client.user.displayAvatarURL())
                        ]})
                        break;
                    case 'tempmute':
                        ...
                        message.reply({
                            embeds: [
                                new Discord.MessageEmbed()
                                    .setColor(client.config.colors.main)
                                    .setDescription(`${client.config.emotes.success} Members who send fast message spam will get muted for \`${client.util.duration(duration)}\``)
                                    .setAuthor('Automod Update', client.user.displayAvatarURL())
                            ]
                        })
                        break;
                ...
                switch (toggle) {
                    ...
                    case 'tempban':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                            .setColor(client.config.colors.main)
                            .setDescription(`${client.config.emotes.success} Members who send walltext will get banned for \`${client.util.duration(duration)}\``)
                            .setAuthor('Automod Update', client.user.displayAvatarURL())
                        ]})
                        break;
                    case 'tempmute':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                            .setColor(client.config.colors.main)
                            .setDescription(`${client.config.emotes.success} Members who send walltext will get muted for \`${client.util.duration(duration)}\``)
                            .setAuthor('Automod Update', client.user.displayAvatarURL())
                        ]})
                        break;
                    case 'disable':
                ...
                switch (toggle) {
                    ...
                    case 'tempban':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                            .setColor(client.config.colors.main)
                            .setDescription(`${client.config.emotes.success} Members who send links will get banned for \`${client.util.duration(duration)}\``)
                            .setAuthor('Automod Update', client.user.displayAvatarURL())
                    ]})
                        break;
                    case 'tempmute':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                            .setColor(client.config.colors.main)
                            .setDescription(`${client.config.emotes.success} Members who send links will get muted for \`${client.util.duration(duration)}\``)
                            .setAuthor('Automod Update', client.user.displayAvatarURL())
                    ]})
                        break;
                    case 'disable':
                ...
                switch (toggle) {
                    ...
                    case 'tempban':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                            .setColor(client.config.colors.main)
                            .setDescription(`${client.config.emotes.success} Members who send invites will get banned for \`${client.util.duration(duration)}\``)
                            .setAuthor('Automod Update', client.user.displayAvatarURL())
                    ]})
                    ...
                    case 'tempmute':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                            .setColor(client.config.colors.main)
                            .setDescription(`${client.config.emotes.success} Members who send invites will get muted for \`${client.util.duration(duration)}\``)
                            .setAuthor('Automod Update', client.user.displayAvatarURL())
                    ]})
                        message.reply(success)
                        break;
                ...
                switch (toggle) {
                    ...
                    case 'tempban':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                            .setColor(client.config.colors.main)
                            .setDescription(`${client.config.emotes.success} Members who mention 5+ users will get banned for \`${client.util.duration(duration)}\``)
                            .setAuthor('Automod Update', client.user.displayAvatarURL())
                    ]})
                        break;
                    case 'tempmute':
                        ...
                        message.reply({ embeds: [
                            new Discord.MessageEmbed()
                            .setColor(client.config.colors.main)
                            .setDescription(`${client.config.emotes.success} Members who mention 5+ users will get muted for \`${client.util.duration(duration)}\``)
                            .setAuthor('Automod Update', client.user.displayAvatarURL())
                    ]})
                        break;
                    case 'disable':
            ...
            case 'channelbypass':
                ...
                switch (toggle) {
                    case 'add':
                        ...
                        if (alreadyInBypassList0?.bypassChannels?.length) return message.reply('This channel is already in the bypass list! You can view the list by running `automod bypass view`')
                        await automodSchema.updateOne({
                            guildID: message.guild.id
                        },
                            {
                    ...
                    case 'remove':
                        ...
                        if (!alreadyInBypassList1?.bypassChannels?.length) return message.reply('This channel is not in the bypass list! You can view the list by running `automod bypass view`')
                        await automodSchema.updateOne({
                            guildID: message.guild.id
                        },
                            {
                    ...
                    case 'view':
                        ...
                        for (let i = 0; i !== bypassChannels.length; ++i) {
                            ...
                            if (!message.guild.channels.cache.get(channel) || message.guild.channels.cache.get(channel).type !== 'GUILD_TEXT') {
                                await automodSchema.updateOne({
                                    guildID: message.guild.id
                                },
                                    {
                        ...
                        const bypassChannels_ = bypassChannels.map(channel => message.guild.channels.cache.get(channel)).filter(channel => channel.type === 'GUILD_TEXT').join(', ');
            ...
            case 'rolebypass':
                ...
                switch (toggle) {
                    case 'add':
                        ...
                        if (alreadyInBypassList0?.bypassRoles?.length) return message.reply('This role is already in the bypass list! You can view the list by running `automod rolebypass view`')
                        await automodSchema.updateOne({
                            guildID: message.guild.id
                        },
                            {
                    ...
                    case 'remove':
                        ...
                        if (!alreadyInBypassList1?.bypassRoles?.length) return message.reply('This role is not in the bypass list! You can view the list by running `automod rolebypass view`')
                        await automodSchema.updateOne({
                            guildID: message.guild.id
                        },
                            {
