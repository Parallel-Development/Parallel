...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (args[0] === 'raw') {
            return message.channel.send('Parallel invite: <https://discord.com/api/oauth2/authorize?client_id=745401642664460319&permissions=2617568510&scope=bot%20applications.commands>\nDiscord server: <https://discord.gg/v2AV3XtnBM>')
        }
