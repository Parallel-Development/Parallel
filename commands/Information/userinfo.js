...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        const userinfo = new Discord.MessageEmbed()
            ...
            .addField('Created', client.util.timestamp(member.user ? user.createdAt : user.createdAt))
        ...
        if (member.user) { 
            ...
            userinfo.addField(`Roles [${member.roles.cache.size - 1}]`, memberRoles.length <= 1024 ? memberRoles : [...member.roles.cache.values()].sort((a, b) => b.position - a.position).slice(0, 10).join(', '), false)
        }
