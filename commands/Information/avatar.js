...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        let absolute = false;
        const absoluteFlagUsed = args.find(arg => arg === '--absolute' || arg === '--a' || arg === '--user' || arg === '--u');
        ...
        const target = await client.util.getMember(message.guild, args[0]) || await client.util.getUser(client, args[0]) || message.member;
