...
exports.run = async (client, message) => {
    ...
    if (links == 'warn') {
        ...
        const userwarned = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been warned with ID \`${code}\` <a:check:800062847974375424> for sending links`)
    ...
    if (links == 'kick') {
        ...
        const userkicked = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been kicked with ID \`${code}\` <a:check:800062847974375424> for sending links`)
    ...
    if (links == 'mute') {
        ...
        const usermuted = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been muted with ID \`${code}\` <a:check:800062847974375424> for sending links`)
    ...
    if (links == 'ban') {
        ...
        const userbanned = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been banned with ID \`${code}\` <a:check:800062847974375424> for sending links`)
    ...
    if (links == 'tempmute') {
        ...
        const usertempmuted = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been muted   \`${code}\` <a:check:800062847974375424> for sending links`)
