...
exports.run = async (client, message) => {
    ...
    let { massmention, massmentionTempBanDuration, massmentionTempMuteDuration } = automodGrab
    ...
    if (massmention == 'warn') {
        ...
        const userwarned = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been warned with ID \`${code}\` for mentioning 5+ users <a:check:800062847974375424> `)
    ...
    if (massmention == 'kick') {
        ...
        const userkicked = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been kicked with ID \`${code}\` for mentioning 5+ users <a:check:800062847974375424> `)
        ...
        message.member.kick('[AUTO] Mass Mention').catch(() => { return })
    ...
    if (massmention == 'mute') {
        ...
        const usermuted = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been muted with ID \`${code}\` for mentioning 5+ users <a:check:800062847974375424> `)
    ...
    if (massmention == 'ban') {
        ...
        const userbanned = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`${message.member} has been banned with ID \`${code}\` for mentioning 5+ users <a:check:800062847974375424> `)
        ...
        message.guild.members.ban(message.member, { reason: '[AUTO] Mass Mention ' }).catch(() => { return })
