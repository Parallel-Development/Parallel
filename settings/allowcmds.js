...
exports.run = async(client, message, args) => {
    ...
    switch (args[1]) {
        case 'enable':
            ...
            break;
        case 'enablecategory':
            const enableCategory = message.guild.channels.cache.find(c => c.name == args.slice(2).join(' '))
        ...
        case 'disablecategory':
            const disableCategory = message.guild.channels.cache.find(c => c.name == args.slice(2).join(' '))
