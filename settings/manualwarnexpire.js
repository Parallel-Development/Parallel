...
exports.run = async (client, message, args) => {
        ...
        const manualwarnexpireEmbed = new Discord.MessageEmbed()
            ...
            .setDescription(
                manualwarnexpire === 'disabled'
                    ...
                    : `All manual warnings, if no duration is provided, are set to expire in \`${client.util.duration(
                          manualwarnexpire
                      )}\``
            );
    ...
    const success = new Discord.MessageEmbed()
        ...
        .setDescription(
            ...
            } Success! Manual warnings with no duration specified will now expire in \`${client.util.duration(
                duration
            )}\``
        );
