...
exports.run = async(client, message, args) => {
    ...
    if (args[1] == 'disable') {
        ...
        const disableSuccess = new Discord.MessageEmbed()
            .setColor('#09fff2')
            .setDescription(`Success! Manual warnings with no duration specified will now never expire`)
    ...
    const success = new Discord.MessageEmbed()
        .setColor('#09fff2')
        .setDescription(`Success! Manual warnings with no duration specified will now expire in \`${args[1]}\``)
