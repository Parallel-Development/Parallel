...
client.on('message', async(message) => {
    ...
    if(!automodCheck) {
        await new automodSchema({
            ...
            fastTempMuteRawDuration: '0',
            walltextTempMuteDuration: 0,
            walltextTempMuteRawDuration: '0',
            linksTempMuteDuration: 0,
            linksTempMuteRawDuration: '0',
            invitesTempMuteDuration: 0,
            invitesTempMuteRawDuration: '0',
            massmentionTempMuteDuration: 0,
            massmentionTempMuteRawDuration: '0',
            filterTempBanDuration: 0,
            filterTempBanRawDuration: '0',
            fastTempBanDuration: 0,
            fastTempBanRawDuration: '0',
            walltextTempBanDuration: 0,
            walltextTempBanRawDuration: '0',
            linksTempBanDuration: 0,
            linksTempBanRawDuration: '0',
