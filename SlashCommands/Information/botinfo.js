...
module.exports = {
    ...
    async execute(client, interaction, args) {
        ...
        const botinfo = new Discord.MessageEmbed()
            ...
            .setDescription('Parallel is a Discord bot with advanced modern moderation features. If you would like to join the development / support server, click [here](https://discord.gg/DcmVMPx8bn)')
