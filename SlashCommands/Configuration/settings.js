...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(command =>
            command
                .setName('allow-commands')
                .setDescription('Manage channels or categories where commands are allowed')
                .addStringOption(option =>
                    option
                        .setName('method')
                        .setDescription('To enable, disable, view disabled, or enable all!')
                        .setRequired(true)
    ...
    async execute(client, interaction, args) {
        return interaction.reply({
            content: 'Please use the message command version of this command!',
            ephemeral: true
        });
