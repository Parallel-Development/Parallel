...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('unmute')
        .setDescription('Unutes a member allowing them to speak in the server')
    ...
    async execute(client, interaction, args) {
        ...
        const rolesToAdd = hasMuteRecord?.roles?.filter(
            role =>
                ...
                interaction.guild.roles.cache.get(role).position < interaction.guild.me.roles.highest.position
        );
