...
module.exports = {
    ...
    async execute(client, interaction, args) {
        ...
        await new DMUserInfraction(client, 'kicked', client.config.colors.punishment[1], interaction, member, { reason: reason, punishmentID: punishmentID, time: 'ignore' });

        await member.kick(reason);

        new Infraction(client, 'Kick', interaction, interaction.member, member, { reason: reason, punishmentID: punishmentID, time: null, auto: false });
        new ModerationLogger(client, 'Kicked', interaction.member, member, interaction.channel, { reason: reason, duration: null, punishmentID: punishmentID })
