...
module.exports = {
    ...
    async execute(client, interaction, args) {
        ...
        const channels = guildLocked.channels.map(
            locked => interaction.guild.channels.cache.get(locked.ID) || locked.ID
        );
            ...
            if (channel.type === 'number' || !getLockSchema) {
                ...
                await channel.permissionOverwrites
                    .set(
                        ...
                        `Command /unlockserver ran by ${interaction.user.tag} (${interaction.user.id})`
                    )
        ...
        global.lockdownCooldown.delete(interaction.guild.id);
        return interaction.editReply(`Successfully unlocked **${displayChannelsToLock}** channels`).catch(() => {
