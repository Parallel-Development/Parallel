...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addUserOption(option =>
            option.setName('member').setDescription('The target you are adding the role to').setRequired(true)
        )
        .addRoleOption(option =>
            option.setName('role').setDescription('The role you are adding to the target member').setRequired(true)
        )
