...
module.exports = {
    ...
    async execute(client, interaction, args) {
        ...
        if (
            ...
            return client.util.throwError(interaction, 'no permission to manage server tags');
        ...
        if (
            ...
            return client.util.throwError(interaction, 'you may only view the server tags');
